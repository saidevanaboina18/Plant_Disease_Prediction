...
- Dataset provided by [Kaggle](https://www.kaggle.com/datasets/vipoooool/new-plant-diseases-dataset)
- Built with [TensorFlow](https://tensorflow.org/) and [Streamlit](https://streamlit.io/)
...
1. Check the [Issues](https://github.com/yourusername/Plant_Disease_Prediction/issues) page
2. Create a new issue with detailed description
3. Include error messages and system information

## 🌟 Star History

[![Star History Chart](https://api.star-history.com/svg?repos=yourusername/Plant_Disease_Prediction&type=Date)](https://star-history.com/#yourusername/Plant_Disease_Prediction&Date)
